...
#### 步骤一：分析60F目标线段在日线结构中的位置

操作商品期货，只需要日线、60F、15F这三个级别即可，目标是**持仓60F级别的趋势波段**，若走势延伸较好则持仓日线级别趋势波段。

需要观察60F目标线段在日线级别结构中处于哪个位置，有几种情况：

- 顺日线方向：大部分情况适合操作，哪怕操作空间不大一般也不会亏损。
- 逆日线方向
  - 日线结构内部的盘整：大多数情况操作空间不大，不是太好操作。
  - 背驰后的反向段：有操作价值，趋势背驰最佳可以估计反向段空间。

**当有量价匹配和基本面支持，无论是否顺日线方向，都是可以择机操作的**。

#### 步骤二：等待开仓信号

1.线段转折初期的开仓信号

线段的划分标准是要突破特征序列关键点，但在实际操作的时候会偏晚，同时追多追空容易被套住。

**当15F笔进入或穿过前特征序列时候，那么就能等后续二买卖点开仓；如果没有进入或穿过，则不操作。**
...
止损位不是静态的，需要根据浮亏情况来变动：

- 开仓止损位：开仓点位的顶底分型。
- 初始浮盈止损位：当头寸**稳定浮盈**时候，把止损位拉到开仓位置。
- 后续止损位：当头寸不断浮盈时候，把止损位移动到关键位置，这样这笔操作最终必然赚钱。

止盈：

- 可以在次级别出现趋势背驰或盘整背驰结构时候止盈
- 也可以在次级别出现二买卖点时候，即60F线段可能转折时候止盈
